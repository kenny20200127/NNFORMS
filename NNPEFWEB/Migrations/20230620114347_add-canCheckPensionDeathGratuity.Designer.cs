...
namespace NNPEFWEB.Migrations
{
    ...
    [Migration("20230620114347_add-canCheckPensionDeathGratuity")]
    partial class addcanCheckPensionDeathGratuity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NNPEFWEB.Models.Menu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NNPEFWEB.Models.MenuGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NNPEFWEB.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NNPEFWEB.Models.RoleMenu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NNPEFWEB.Models.User", b =>
                {
                    ...
                    b.Property<bool?>("CanCheckPensionDeathGrantuity")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("NNPEFWEB.Models.ef_ContactUs", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("NNPEFWEB.Models.UserRole", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("NNPEFWEB.Models.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NNPEFWEB.Models.Menu", b =>
                {
                    b.HasOne("NNPEFWEB.Models.MenuGroup", "MenuGroup")
                        .WithMany("Menus")
            ...
            modelBuilder.Entity("NNPEFWEB.Models.RoleMenu", b =>
                {
                    b.HasOne("NNPEFWEB.Models.Menu", "Menu")
                        .WithMany("RoleMenus")
                        .HasForeignKey("MenuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NNPEFWEB.Models.Role", "Role")
                        .WithMany("RoleMenus")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NNPEFWEB.Models.UserRole", b =>
                {
                    ...
                    b.HasOne("NNPEFWEB.Models.User", "User")
                        .WithMany("UserRoles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
