...
{
    public class HistReportsController : Controller
    {
        ...
        public HistReportsController(IGeneratePdf generatepdf, IUnitOfWorks unitOfWorks, IPersonInfoService personinfoService, IPersonService personService,
        ...
        [HttpGet]
        public IActionResult PersonnelHist(string year, string svcno)
        {
            try
            {
              
                    var pp2 = personinfoService.GetPersonHist(year, svcno).ToList();
        ...
        public async Task<IActionResult> downloadForm(string svcno, string year)
        {
            ...
            var ppp = _context.ef_personalInfosHist.Where(o => o.serviceNumber == svcno && o.FormYear == year).FirstOrDefault();
            var pp = new PersonalInfoModel();
            using (SqlConnection sqlcon = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand("DownloadFormRatingHist", sqlcon))
                {
        ...
        public async Task<IActionResult> downloadForm2(string svcno,string year)
        {
            var systemsInfo = _systemsInfo.GetSysteminfo();
            if (svcno == null)
            {
        ...
        public async Task<IActionResult> downloadFormTraining(string svcno, string year)
        {
            var systemsInfo = _systemsInfo.GetSysteminfo();
            if (svcno == null)
            {
            ...
            using (SqlConnection sqlcon = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand("DownloadFormTrainingHist", sqlcon))
                {
                    cmd.CommandTimeout = 1200;
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@svcno", svcno));
        ...
        public async Task<IActionResult> downloadFormTraining2(string svcno, string year)
        {
            var systemsInfo = _systemsInfo.GetSysteminfo();
            if (svcno == null)
            {
        ...
        public async Task<IActionResult> downloadFormOfficer(string svcno, string year)
        {
            try
            {
            var systemsInfo = _systemsInfo.GetSysteminfo();
            ...
            using (SqlConnection sqlcon = new SqlConnection(connectionString))
            {
                using (SqlCommand cmd = new SqlCommand("DownloadFormOfficerhist", sqlcon))
                {
                    cmd.CommandTimeout = 1200;
                    cmd.CommandType = System.Data.CommandType.StoredProcedure;
                    cmd.Parameters.Add(new SqlParameter("@svcno", svcno));
        ...
        public async Task<IActionResult> downloadFormOfficer2(string svcno, string year)
        {
            var systemsInfo = _systemsInfo.GetSysteminfo();
            if (svcno == null)
            {
